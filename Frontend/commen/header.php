        ...
        <aside class="sidebar">
            ...
            <ul class="nav-links">
                <li class="<?php echo ($current_page == 'home.php') ? 'active' : ''; ?>">
                    <a href="home.php"><div class="nav-item-content"><i class="fa-solid fa-house"></i> Home</div></a>
                </li>
                <li class="<?php echo ($current_page == 'services.php') ? 'active' : ''; ?>">
                    <a href="../user/services.php"><div class="nav-item-content"><i class="fa-solid fa-layer-group"></i> Services</div></a>
                </li>
                <li class="<?php echo ($current_page == 'myProjects.php' || $current_page == 'exploreProject.php') ? 'active' : ''; ?>">
                    <a href="../user/myProjects.php"><div class="nav-item-content"><i class="fa-solid fa-folder-open"></i> My Projects</div></a>
                </li>
            </ul>
            ...
            <ul class="nav-links">
                <li class="<?php echo ($current_page == 'chat.php') ? 'active' : ''; ?>">
                    <a href="../user/chat.php"><div class="nav-item-content"><i class="fa-solid fa-comment-dots"></i> Live Chat</div><span class="dot"></span></a>
                </li>
                <li class="<?php echo ($current_page == 'appointment.php') ? 'active' : ''; ?>">
                    <a href="../user/appointment.php"><div class="nav-item-content"><i class="fa-solid fa-calendar-days"></i> Book Appointment</div></a>
                </li>
            </ul>
            ...
            <ul class="nav-links">
                <li class="<?php echo ($current_page == 'payment.php') ? 'active' : ''; ?>">
                    <a href="../user/payment.php"><div class="nav-item-content"><i class="fa-solid fa-credit-card"></i> Plans & Payments</div></a>
                </li>
            </ul>
            ...
            <ul class="nav-links">
                <li class="<?php echo ($current_page == 'about.php') ? 'active' : ''; ?>">
                    <a href="../user/about.php"><div class="nav-item-content"><i class="fa-solid fa-circle-info"></i> About</div></a>
                </li>
            </ul>
        </aside>
