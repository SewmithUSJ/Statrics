...
<div class="section-container" style="padding-bottom: 60px;">
    ...
    <div class="usr-proj-grid">
        ...
        <div class="usr-panel-card">
            ...
            <form id="projectRequestForm" onsubmit="handleProjectSubmission(event)" class="usr-compact-form">
                ...
                <div class="usr-input-wrapper">
                    ...
                    <select id="projService" required onchange="toggleConditionalFields(this.value)">
                        <option value="" disabled selected>Choose a serivice...</option>
                ...
                <div id="conditionalFieldsContainer" style="margin-top: 15px;">
                    ...
                    <div id="fieldsDataAnalysis" class="conditional-field-block" style="display: none; margin-bottom: 15px;">
                        <div class="usr-input-wrapper" style="margin-bottom: 15px;">
                            <label>Dataset Link</label>
                            <input type="url" id="daDatasetLink" placeholder="https://example.com/dataset.csv">
                        </div>
                        <div class="usr-input-wrapper">
                            <label>Target Population Description</label>
                            <textarea id="daPopulationDesc" rows="3" placeholder="Describe the sample space, sample sizes, and structural criteria..."></textarea>
                        </div>
                    </div>
                    ...
                    <div id="fieldsConsultantIntermediate" class="conditional-field-block" style="display: none; margin-bottom: 15px;">
                        <div class="usr-input-wrapper">
                            <label>Dataset Link</label>
                            <input type="url" id="ciDatasetLink" placeholder="https://example.com/secure-cloud-storage">
                        </div>
                    </div>
                    ...
                    <div id="fieldsAcademicResearch" class="conditional-field-block" style="display: none; margin-bottom: 15px;">
                        ...
                        <div class="usr-input-wrapper">
                            <label>Citation & Reference Requirements</label>
                            <textarea id="arCitationDetails" rows="3" placeholder="Specify formatting targets (APA 7th, Harvard, IEEE) or specific standard references..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="usr-input-wrapper">
                    ...
                    <textarea id="projAbout" rows="4" required placeholder="Describe engineering scope, analytical parameters, or visualization formatting styles..."></textarea>
                </div>
                ...
                <div class="usr-form-row-2">
                    ...
                    <div class="usr-input-wrapper">
                        ...
                        <select id="projBudget" required>
                            ...
                            <option value="tier_2">Medium($250 - $500)</option>
                            <option value="tier_3">High</option>
                        </select>
                    </div>
                </div>
                ...
                <button type="submit" class="cta-btn" style="width: 100%; padding: 12px; margin-top: 10px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 30px;">
            ...
            <div class="usr-panel-card">
                ...
                <div class="usr-portfolio-stream">
                    <!-- Stream Item 1 -->
            ...
            <!-- NEW Matrix Box C: Cancel Staged Allocations Pipeline -->
            <div class="usr-panel-card">
                <h3 class="usr-card-title"><i class="fa-solid fa-rectangle-xmark" style="color: #ef4444;"></i> Cancel Operation Streams</h3>
                <p style="color: var(--text-muted); font-size: 12px; margin-top: -10px; margin-bottom: 20px;">Deprovision active assignments or retract pending resource allocations from evaluation matrices.</p>
                
                <form id="cancelRequestForm" onsubmit="handleCancelSubmission(event)" class="usr-compact-form">
                    <div class="usr-input-wrapper">
                        <label>Select Active or Pending Target Project</label>
                        <select id="cancelTarget" required>
                            <option value="" disabled selected>Select structural stream to drop...</option>
                            <option value="presentrics">Presentrics Student Attendance Intel (Active)</option>
                            <option value="polythene">Public Polythene Usage Perception Run (Active)</option>
                            <option value="aquarelief">AquaRelief Flood Management Module (Pending)</option>
                        </select>
                    </div>
                    <div class="usr-input-wrapper">
                        <label>Reason for Cancellation Request</label>
                        <textarea id="cancelReason" rows="3" required placeholder="Outline context changes, budget recalculations, or shifting timelines..."></textarea>
                    </div>
                    <button type="submit" class="cta-btn" style="width: 100%; padding: 12px; margin-top: 10px; background: linear-gradient(135deg, #dc2626, #991b1b); border: 1px solid #ef444480;">
                        <i class="fa-solid fa-ban"></i> Terminate Selected Pipeline
                    </button>
                    
                    <div id="usrCancelSuccessToast" class="usr-toast-success-panel" style="background: rgba(220, 38, 38, 0.15); border-color: #ef4444; color: #fca5a5;">
                        <i class="fa-solid fa-circle-exclamation"></i> Termination ticket generated. Scheduled for engineering rollback audit.
                    </div>
                </form>
            </div>
